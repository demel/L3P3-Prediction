##### Elastic Net Temporal Window Cross Validation Experiment With Preprocessing Phase Change#####
require(lubridate)
require(plyr)
require(dplyr)
require(glmnet)
...
find_best_model<-function(target_variable,measure="auc",target){
  ...
  #######NEW CODE#######
  #Retraining phase with whole training+validation datasets
  input<-rbind(complete_data$training[,2:(length(complete_data$training)-1)],complete_data$validation[,2:(length(complete_data$validation)-1)])
  output<-c(complete_data$training[,length(complete_data$training)],complete_data$validation[,length(complete_data$validation)])
  ...
  tryCatch({best_model<-cv.glmnet(x=input_matrix,y=output_matrix,family="binomial",type.measure=measure,alpha=best_alpha)})  
  ######END OF NEW CODE######
  ...
  prediction<-factor(as.numeric(predict(best_model,newx=input_matrix,type="class",s="lambda.min")))
  print("prediction made!")
  ...
  things_to_return<-list("best_alpha"=best_alpha,"confusion_matrix"=confusion_matrix,"precision"=precision,"recall"=recall,"fscore"=fscore,"model"=best_model)
...
#tmpb5f5_v2_1<-cross_validation_for_alpha(1)
# tmpb5f5_v2_2<-cross_validation_for_alpha(1)
# tmpb5f5_v2_3<-cross_validation_for_alpha(1)
# tmpb5f5_v2_4<-cross_validation_for_alpha(1)
# tmpb5f5_v2_5<-cross_validation_for_alpha(1)
# tmpb5f5_v2_6<-cross_validation_for_alpha(1)
# tmpb5f5_v2_7<-cross_validation_for_alpha(1)
# tmpb5f5_v2_8<-cross_validation_for_alpha(1)
tmpb5f5_v2_9<-cross_validation_for_alpha(1)
tmpb5f5_v2_10<-cross_validation_for_alpha(1)
tmpb5f5_v2_11<-cross_validation_for_alpha(1)
tmpb5f5_v2_12<-cross_validation_for_alpha(1)
tmpb5f5_v2_13<-cross_validation_for_alpha(1)
tmpb5f5_v2_14<-cross_validation_for_alpha(1)
tmpb5f5_v2_15<-cross_validation_for_alpha(1)
tmpb5f5_v2_16<-cross_validation_for_alpha(1)
tmpb5f5_v2_17<-cross_validation_for_alpha(1)
tmpb5f5_v2_18<-cross_validation_for_alpha(1)
tmpb5f5_v2_19<-cross_validation_for_alpha(1)
tmpb5f5_v2_20<-cross_validation_for_alpha(1)
