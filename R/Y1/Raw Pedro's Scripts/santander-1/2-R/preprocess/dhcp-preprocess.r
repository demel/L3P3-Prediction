library(gsubfn)
file <- "C:\\Users\\capelastegui\\workspace\\OFP\\Santander\\Logs_2\\CommunicationSystems\\DHCP\\dhcp.log"
lines <- readLines(file, 10)
regex <- readLines(file("C:\\Users\\capelastegui\\workspace\\OFP\\tmp2.txt", "rt"),1)
log<- data.frame(strapplyc(lines, regex, simplify = "rbind"))

xmlFile <- "C:\\Users\\capelastegui\\workspace\\OFP\\Santander\\tables\\tables\\table-dhcp-infoblox-santander.xml"
